    ...
    google = function () {
        ...
        this._initUp = function () {
            var options = {
                ...
                path: '/speech-api/full-duplex/v1/up?lm=dictation&client=chromium&lang=' + this.language + '&pair=' + this.pair + '&key=' + KEY + '&interim',
                method: 'POST',
                headers: {
...
//            if (json.result[0] && json.result[0].alternative) {
//                this.emit('data', {message: json.result[0].alternative[0].transcript, final: false});
